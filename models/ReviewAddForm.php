...
class ReviewAddForm extends Model
{
    public $title;
    public $content;
    ...
    public function rules()
    {
        return [
            ['content', 'required'],
            ['title', 'safe'],
            [['mainImage'], 'file', 'skipOnEmpty' => false, 'extensions' => 'png, jpg, gif, jpeg'],
            [['gallery'], 'file', 'skipOnEmpty' => false, 'extensions' => 'png, jpg, gif, jpeg', 'maxFiles' => 20],
        ];
    }
